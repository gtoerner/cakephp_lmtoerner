...
<div class="users form">
    ...
    <?= $this->Form->create() ?>
    <fieldset>
        <legend><?= __d('CakeDC/Users', 'Login - Please enter your username and password') ?></legend>
        
            <?= $this->Form->control('username', ['label' => __d('CakeDC/Users', 'Username:'), 'required' => true, 'class'=>'form-control']) ?>
            <br>
            <?= $this->Form->control('password', ['label' => __d('CakeDC/Users', 'Password:'), 'required' => true, 'class'=>'form-control']) ?>
